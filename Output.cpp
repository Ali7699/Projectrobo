...
void Output::CreateDesignModeToolBar() const
{
	...
	///TODO: Change the path of the images as needed (Done Ali)
	...
	MenuItemImages[ITM_ADD_WATER_PIT] = "images\\water.jpg";
	MenuItemImages[ITM_ADD_WORKSHOP] = "images\\Workshop.jpg";
	MenuItemImages[ITM_ROTATING_GEAR] = "images\\Gear.jpg";
	...
	///TODO: Prepare images for each menu item and add it to the list (Done Ali)
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_REBOOT_AND_REPAIR] = "images\\Reboot.jpg";
